...
A distributed computing system for coordinating Monero RandomX workloads across general purpose CPUs.
...
```mermaid
flowchart TB
    CLI["User / cluster CLI"] --> C["(Your PC or deployed instance)<br/>Worker Coordinator & Registry<br/>Telemetry & Health<br/> Mining Result"]
